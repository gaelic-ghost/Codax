...
Generated on 2026-03-12T12:01:58.556Z.

This tracker is derived from the pinned `codex-schemas/v0.114.0` tree and checked against `Codax/Controllers/Connection//tmp/CodexSchema-0.114.generated.swift`.
...
- Reachable protocol-surface types: 352
- Non-reachable exported types: 145
- Client request methods: 52 (5 missing)
...
| `plugin/list` | `pluginList` | `PluginListParams` | `MISSING_RESPONSE_MAP` | missing |
...
| `plugin/uninstall` | `pluginUninstall` | `PluginUninstallParams` | `MISSING_RESPONSE_MAP` | missing |
...
| `command/exec/write` | `commandExecWrite` | `CommandExecWriteParams` | `MISSING_RESPONSE_MAP` | missing |
| `command/exec/terminate` | `commandExecTerminate` | `CommandExecTerminateParams` | `MISSING_RESPONSE_MAP` | missing |
| `command/exec/resize` | `commandExecResize` | `CommandExecResizeParams` | `MISSING_RESPONSE_MAP` | missing |
...
| `hook/started` | `hookStarted` | `undefined` | done |
| `turn/completed` | `turnCompleted` | `undefined` | done |
| `hook/completed` | `hookCompleted` | `undefined` | done |
...
| `command/exec/outputDelta` | `commandExecOutputDelta` | `undefined` | done |
